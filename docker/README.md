...
| [`images/`](images/README.md) | Build the **guest system base image** (Arch + `linux-cachyos` + Waydroid + gamescope) for Android/Linux instances | Backing file for qcow2 overlays that actually run under QEMU inside instances |
